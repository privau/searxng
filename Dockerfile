...
ENV UPSTREAM_COMMIT=01be2612ab845771929181592931464f179357ea
...
# set env
ENV GRANIAN_PROCESS_NAME="searxng" GRANIAN_INTERFACE="wsgi" GRANIAN_HOST="::" GRANIAN_PORT="8080" GRANIAN_WEBSOCKETS="false" GRANIAN_LOOP="uvloop" GRANIAN_BLOCKING_THREADS="1" GRANIAN_WORKERS_KILL_TIMEOUT="30" \
