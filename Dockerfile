...
ENV UPSTREAM_COMMIT=77b3fdc34deede4080cb17024ade0927fc5efea3
...
IMAGE_PROXY=true PROXY= VALKEY_URL= REDIS_URL= LIMITER= BASE_URL= SECRET_KEY= CAPTCHA= MARGINALIA_API= JINA_API= BRAVE_API= NAME= SEARCH_DEFAULT_LANG= SEARCH_ENGINE_ACCESS_DENIED= SEARCH_ENGINE_CAPTCHA= ENGINE_TIMEOUT= PUBLIC_INSTANCE= \
